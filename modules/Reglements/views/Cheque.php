...
class Reglements_Cheque_View extends Vtiger_Index_View
{
    ...
    public function generer($request)
    {
        ...
        $header = '<br><img src="http://100.1.1.8/ERP/erptest/public_html/layouts/resources/Logo/bp.png" /> <h3>Edicom SA</h3>
                            ...
                            <strong style="margin-left: 80px;">BORDEREAU DES REMISE DES VALEURS</strong> <strong style="margin-left: 200px"> N° '.$encaissement["bordereau"].' </strong> <br><br>
                            <strong style="margin-left: 80px;font-weight: 500">CHEQUES</strong><br><br>';
 ...
 <table align="center" style="border-collapse: collapse; border: 1px solid black;">
  <thead>
    <tr style="border: 1px solid grey;">
        <th style="width: 120px;width;height: 20px;background-color: #e9ecef;text-align: center; border: 1px solid black;" >
            Facture
        </th>
        <th style="width: 120px;width;height: 20px;background-color: #e9ecef;text-align: center; border: 1px solid black;">
            Raison sociale
    ...
    <tbody>
 <tr >
     <?php  echo ' <td style="border: 1px solid black;height: 20px;">'.$encaissement["number"].'</td>'; ?>
     <?php  echo ' <td style="border: 1px solid black;height: 20px;">'.$encaissement["number"].'</td>'; ?>
     <?php  echo ' <td style="border: 1px solid black;height: 20px;">'.$encaissement["number"].'</td>'; ?>
     <?php  echo ' <td style="border: 1px solid black;height: 20px;">'.$encaissement["number"].'</td>'; ?>
     <?php  echo ' <td style="border: 1px solid black;height: 20px;">'.$encaissement["number"].'</td>'; ?>
