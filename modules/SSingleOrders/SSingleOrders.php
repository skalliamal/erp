...
class SSingleOrders extends Vtiger_CRMEntity
{
	...
	public $table_index = 'ssingleordersid';

	/**
	 * Mandatory table for supporting custom fields.
	 */
	public $customFieldTable = ['u_yf_ssingleorderscf', 'ssingleordersid'];

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	public $tab_name = ['vtiger_crmentity', 'u_yf_ssingleorders', 'u_yf_ssingleorderscf', 'u_yf_ssingleorders_address', 'vtiger_entity_stats'];
	...
	public $list_fields = [
		...
		'LBL_SUBJECT' => ['ssingleorders', 'subject'],
		...
		if ($eventType === 'module.postinstall') {
			...
			if ($modcommentsModuleInstance && file_exists('modules/ModComments/ModComments.php')) {
				...
				if (class_exists('ModComments')) {
					ModComments::addWidgetTo(['SSingleOrders']);
				}
			}
