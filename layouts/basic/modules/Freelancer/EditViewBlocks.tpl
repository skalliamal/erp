		...
		<form class="form-horizontal recordEditView" id="EditView" name="EditView" method="post" action="index.php"
			...
			<script type="text/javascript">
                $(document).ready(function() {
                    $('#Freelancer_editView_fieldName_date_naissance').change(function(){
                        var birth_date =$('#Freelancer_editView_fieldName_date_naissance').val();
                        var today = moment(new Date, 'DD/MM/YYYY');
                        var birth_date = moment(birth_date, 'DD/MM/YYYY');
                        var age= today.diff(birth_date, 'years');
                        var retraite =60-age;
                        document.getElementById('Freelancer_editView_fieldName_age').value=age;
                        document.getElementById('Freelancer_editView_fieldName_retraite').value=retraite;
                    });
                    $('#Freelancer_editView_fieldName_date_embauche').change(function(){
                        var ate_embauche =$('#Freelancer_editView_fieldName_date_embauche').val();
                        var today = moment(new Date, 'DD/MM/YYYY');
                        var ate_embauche = moment(ate_embauche, 'DD/MM/YYYY');
                        var age= today.diff(ate_embauche, 'years');
                        document.getElementById('Freelancer_editView_fieldName_anciennete').value=age;
                    });
                });
			</script>