		...
		<div class="widget_header row">
			...
			<div class="float-right col-md-6 form-inline">
				...
				<span class="btn-group" style="margin-right: 10px;">
					<button class="btn btn-success importFieldModal" type="button" onclick='window.location.href="index.php?module=LayoutEditor&parent=Settings&view=importCustomField"'>
